...
export const characters: Character[] = [
  {
    ...
    bonds: "Os refugiados da caravana. Sua irmã, deixada em um convento em chamas. Padre Halbrecht, mentor de juventude.",
    items: [
    ...
    evolution: "Aprendeu o milagre menor 'Luz Curativa'. Recusou-se a executar um ladrão faminto em Thistle Hold.",
    relations: "Padre Halbrecht (mentor), Irmã Maelia (aliada), Capitão Draven (desconfiança mútua).",
  },
  {
